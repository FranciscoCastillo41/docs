...
description: "Use Python to query macro-economic data, treasury yields, and point-in-time observations from the MacroData API."
icon: "python"
iconType: "brands"
...
API_KEY = os.environ["MACRODATA_API_KEY"]
BASE = "https://api.macrodata.dev"
